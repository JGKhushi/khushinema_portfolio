...
/**
 * Bundled snapshot of the portfolio content. The site fetches the live
 * `/api/v1/overview` first; this guarantees a full, instant render even when
 * the backend is asleep or unreachable. Keep in sync with backend/src/seed/data.js.
 */
export const fallbackOverview: Overview = {
  profile: {
    ...
    socials: [
      { label: 'GitHub', handle: 'JGKhushi', url: 'https://github.com/JGKhushi', icon: 'github', order: 1 },
      { label: 'LinkedIn', handle: 'jgkhushi-nema', url: 'https://linkedin.com/in/jgkhushi-nema', icon: 'linkedin', order: 2 },
      { label: 'LeetCode', handle: 'Khushi_nema_', url: 'https://leetcode.com/u/Khushi_nema_', icon: 'code', order: 3 },
      { label: 'CodeChef', handle: 'khush_i', url: 'https://www.codechef.com/users/khush_i', icon: 'terminal', order: 4 },
      { label: 'GeeksforGeeks', handle: 'khushinsxza', url: 'https://www.geeksforgeeks.org/user/khushinsxza/', icon: 'braces', order: 5 },
      { label: 'Email', handle: 'khushinema22@gmail.com', url: 'mailto:khushinema22@gmail.com', icon: 'mail', order: 6 },
    ],
    stats: [
  ...
  experience: [
    {
      ...
      stack: ['TypeScript', 'Strapi', 'React', 'FastAPI', 'PostgreSQL', 'SQLAlchemy', 'OpenCV', 'Shapely', 'Google Gemini', 'Playwright'],
      order: 1,
    },
    {
  ...
  projects: [
    {
      ...
      highlights: [
        ...
        { text: 'Integrated a chatbot for automated query resolution.', metric: '~40% fewer manual support interactions' },
    ...
    },
    {
      ...
      highlights: [
        ...
        { text: 'Optimized PostgreSQL queries via Prisma ORM.', metric: '~25% faster average API response under load' },
    ...
    },
    {
      ...
      stack: ['React', 'FastAPI', 'PostgreSQL', 'SQLAlchemy', 'OpenCV', 'Shapely', 'Google Gemini', 'Python'],
      highlights: [
  ...
  achievements: [
    ...
    },
    {
      ...
      detail: 'Active problem solver on LeetCode, with ongoing practice on CodeChef and GeeksforGeeks.',
